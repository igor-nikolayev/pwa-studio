...
import FilterItem from '@magento/venia-ui/lib/components/FilterModal/FilterList/filterItem';
import defaultClasses from '@magento/venia-ui/lib/components/FilterModal/FilterList/filterList.module.css';
import FilterItemRadioGroup from '@magento/venia-ui/lib/components/FilterModal/FilterList/filterItemRadioGroup';
...
const FilterList = props => {
    ...
    return (
        <Fragment>
            <ul className={classes.items} style={{display:  group ==='color' ? 'flex': 'block'}}>
                {itemElements}
                {showMoreLessItem}
            </ul>
        </Fragment>
